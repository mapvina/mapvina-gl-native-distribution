...
/**
 ...
 <a
 href="https://mapvina.io/github/mapvina-style-spec/expressions/#interpolate"><code>interpolate</code></a>
 expression operator in the MapVina Style Spec.
 */
...
/**
 ...
 <a href="https://mapvina.io/github/mapvina-style-spec/expressions/">MapVina Style Spec</a>.
 */
...
/**
 ...
 <a href="https://mapvina.io/github/mapvina-style-spec/expressions/#zoom"><code>zoom</code></a>
 expression operator in the MapVina Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a
 href="https://mapvina.io/github/mapvina-style-spec/expressions/#heatmap-density"><code>heatmap-density</code></a>
 expression operator in the MapVina Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a
 href="https://mapvina.io/github/mapvina-style-spec/expressions/#line-progress"><code>line-progress</code></a>
 expression operator in the MapVina Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a
 href="https://mapvina.io/github/mapvina-style-spec/expressions/#geometry-type"><code>geometry-type</code></a>
 expression operator in the MapVina Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://mapvina.io/github/mapvina-style-spec/expressions/#id"><code>id</code></a>
 expression operator in the MapVina Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a
 href="https://mapvina.io/github/mapvina-style-spec/expressions/#properties"><code>properties</code></a>
 expression operator in the MapVina Style Spec.
 */
