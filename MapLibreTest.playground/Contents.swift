/*:
 * The MapVina Test Playground demonstrates basic rendering of a Mapbox style using the current MapVina binary.
 * Useful for testing the data in the`binaryTarget[]` in this Swift Package repo.
 * Downloads the MapVina `.xcframework` and creates a simple map, thereby testing the Swift Package Manager workflow.
...
// Awaiting https://github.com/mapvina/mapvina-native/issues/1979
